...
public interface UsersService {
     ...
     */
    List<Users> findByMultipleIds(List<String> usersIds, boolean orderedReturn);
    ...
    /*
     * Returns the associated attendeeses for given Users id.
     *
     * @param email value of email; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Attendees instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<Attendees> findAssociatedAttendeeses(String email, Pageable pageable);
